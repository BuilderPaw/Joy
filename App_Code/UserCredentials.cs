...
public class UserCredentials
{
    ...
    public int[] ListReports() // populate into an int array a list of all reports available to the user
    {
        ...
        for (int i = 0; i < group.Length; i++)
        {
            ...
            else if (group[i].ToString().Equals("MRReportsCaretaker"))
            {
                reportList[j] = 10;
                j++;
            }
    ...
    public static string StaffId // StaffID in Staff table
    {
        get
        {
            ...
            {
                return HttpContext.Current.Session["UCStaffId"].ToString();
            }
        }
        set
        {
    ...
    public static string StaffNameId // StaffNameID in StaffName table
    {
        get
        {
            ...
            {
                return HttpContext.Current.Session["UCStaffNameId"].ToString();
            }
        }
        set
        {

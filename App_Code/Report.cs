    ...
    public static string InsertQuery()
    {
        ...
        if (Name.Equals("MR Incident Report") && Version == "1") // MR Incident Report Version 1
        {
            insertQuery = "INSERT INTO " + Table + " (ReportId, RCatId, StaffId, StaffName, ShiftId, ShiftDate, ShiftDOW, EntryDate, AuditVersion, Report_Table, Report_Version, ModifyDate, ReportStat, ReadByList, Comments, NoOfPerson, FirstName1, LastName1, Contact1, PartyType1, Witness1, MemberNo1, CardHeld1, SignInSlip1, SignedInBy1, PDate1," +
                ...
                " TxtTimeM, TxtTimeTC, PlayerId1, PlayerId2, PlayerId3, PlayerId4, PlayerId5, Alias1, Alias2, Alias3, Alias4, Alias5, MemberSince1, MemberSince2, MemberSince3, MemberSince4, MemberSince5) VALUES(" + Id + ", 1, " + SelectedStaffId + ", '" + SelectedStaffName + "' ," + ShiftId + ", (CONVERT(DateTime,'" + ShiftDate + "',103)), '" + ShiftDOW + "', (CONVERT(DateTime,'" + EntryDate + "',103)), " + AuditVersion + ", 'rptMRIncident', 1, current_timestamp, 'Awaiting Completion', ',' + '" + UserCredentials.StaffId + "' + ',', '" + Report.Comment + "', " + ReportIncidentMr.NoOfPerson + ", '" + ReportIncidentMr.First1 + "', '" + ReportIncidentMr.Last1 + "', '" + ReportIncidentMr.Contact1 + "', '" + ReportIncidentMr.Type1 + "', '" + ReportIncidentMr.Witness1 + "'," +
                ...
                " '" + ReportIncidentMr.MemberSince1 + "', '" + ReportIncidentMr.MemberSince2 + "', '" + ReportIncidentMr.MemberSince3 + "', '" + ReportIncidentMr.MemberSince4 + "', '" + ReportIncidentMr.MemberSince5 + "');";
        }
        ...
        if (Name.Equals("CU Incident Report") && Version == "1") // CU Incident Report Version 1
        {
            insertQuery = "INSERT INTO " + Table + " (ReportId, RCatId, StaffId, StaffName, ShiftId, ShiftDate, ShiftDOW, EntryDate, AuditVersion, Report_Table, Report_Version, ModifyDate, ReportStat, ReadByList, Comments, NoOfPerson, FirstName1, LastName1, Contact1, PartyType1, Witness1, MemberNo1, CardHeld1, SignInSlip1, SignedInBy1, PDate1," +
                ...
                " TxtCamETimeTC4, TxtCamSTimeH5, TxtCamSTimeM5, TxtCamSTimeTC5, TxtCamETimeH5, TxtCamETimeM5, TxtCamETimeTC5, TxtCamSTimeH6, TxtCamSTimeM6, TxtCamSTimeTC6," +
                " TxtCamETimeH6, TxtCamETimeM6, TxtCamETimeTC6, TxtCamSTimeH7, TxtCamSTimeM7, TxtCamSTimeTC7, TxtCamETimeH7, TxtCamETimeM7, TxtCamETimeTC7, TxtTimeH," +
                " TxtTimeM, TxtTimeTC, PlayerId1, PlayerId2, PlayerId3, PlayerId4, PlayerId5, Alias1, Alias2, Alias3, Alias4, Alias5, MemberSince1, MemberSince2, MemberSince3, MemberSince4, MemberSince5) VALUES(" + Id + ", 9, " + SelectedStaffId + ", '" + SelectedStaffName + "' ," + ShiftId + ", (CONVERT(DateTime,'" + ShiftDate + "',103)), '" + ShiftDOW + "', (CONVERT(DateTime,'" + EntryDate + "',103)), " + AuditVersion + ", 'rptUMIncident', 1, current_timestamp, 'Awaiting Completion', ',' + '" + UserCredentials.StaffId + "' + ',', '" + Report.Comment + "', " + ReportIncidentCu.NoOfPerson + ", '" + ReportIncidentCu.First1 + "', '" + ReportIncidentCu.Last1 + "', '" + ReportIncidentCu.Contact1 + "', '" + ReportIncidentCu.Type1 + "', '" + ReportIncidentCu.Witness1 + "'," +
                ...
                " '" + ReportIncidentCu.MemberSince1 + "', '" + ReportIncidentCu.MemberSince2 + "', '" + ReportIncidentCu.MemberSince3 + "', '" + ReportIncidentCu.MemberSince4 + "', '" + ReportIncidentCu.MemberSince5 + "');";
        }
        ...
        if (Name.Equals("CU Duty Managers") && Version.ToString() == "1") // CU Duty Manager Version 1
        {
            insertQuery = "INSERT INTO " + Table + " (ReportId, RCatId, StaffId, StaffName, ShiftId, ShiftDate, ShiftDOW, EntryDate, AuditVersion, Report_Table, Report_Version, ModifyDate, ReportStat, ReadByList, Comments, Supervisors, Whs, CostSavings, ClubPresent, ClubMaintenance, Absenteeism, StaffIssues, Gaming, KeySecurity, Cameras, GeneralComments," +
                " LuckyRewards, Compliance) VALUES(" + Id + ", 7, " + SelectedStaffId + ", '" + SelectedStaffName + "' ," + ShiftId + ", (CONVERT(DateTime,'" + ShiftDate + "',103)), '" + ShiftDOW + "', (CONVERT(DateTime,'" + EntryDate + "',103)), " + AuditVersion + ", 'rptUMDM', 1, current_timestamp, 'Awaiting Completion', ',' + '" + UserCredentials.StaffId + "' + ',', '" + Report.Comment + "', '" + ReportDutyManagerCu.Sup + "', '" + ReportDutyManagerCu.Whs + "', '" + ReportDutyManagerCu.Cost + "', '" + ReportDutyManagerCu.ClubPres + "', '" + ReportDutyManagerCu.ClubMain + "', '" + ReportDutyManagerCu.Absent + "'," +
                " '" + ReportDutyManagerCu.StaffIssues + "', '" + ReportDutyManagerCu.Gaming + "', '" + ReportDutyManagerCu.KeySec + "', '" + ReportDutyManagerCu.Cameras + "', '" + ReportDutyManagerCu.GenComm + "', '" + ReportDutyManagerCu.LuckyRewards + "',  '" + ReportDutyManagerCu.Compliance + "');";
        }

        if (Name.Equals("MR Duty Managers") && Version.ToString() == "1") // MR Duty Manager Version 1
        {
            insertQuery = "INSERT INTO " + Table + " (ReportId, RCatId, StaffId, StaffName, ShiftId, ShiftDate, ShiftDOW, EntryDate, AuditVersion, Report_Table, Report_Version, ModifyDate, ReportStat, ReadByList, Comments, Supervisors, Whs, CostSavings, ClubPresent, ClubMaintenance, Absenteeism, StaffIssues, Gaming, KeySecurity, Cameras, GeneralComments," +
                " LuckyRewards, Compliance) VALUES(" + Id + ", 2, " + SelectedStaffId + ", '" + SelectedStaffName + "' ," + ShiftId + ", (CONVERT(DateTime,'" + ShiftDate + "',103)), '" + ShiftDOW + "', (CONVERT(DateTime,'" + EntryDate + "',103)), " + AuditVersion + ", 'rptMRDM', 1, current_timestamp, 'Awaiting Completion', ',' + '" + UserCredentials.StaffId + "' + ',', '" + Report.Comment + "', '" + ReportDutyManagerMr.Sup + "', '" + ReportDutyManagerMr.Whs + "', '" + ReportDutyManagerMr.Cost + "', '" + ReportDutyManagerMr.ClubPres + "', '" + ReportDutyManagerMr.ClubMain + "', '" + ReportDutyManagerMr.Absent + "'," +
                " '" + ReportDutyManagerMr.StaffIssues + "', '" + ReportDutyManagerMr.Gaming + "', '" + ReportDutyManagerMr.KeySec + "', '" + ReportDutyManagerMr.Cameras + "', '" + ReportDutyManagerMr.GenComm + "', '" + ReportDutyManagerMr.LuckyRewards + "',  '" + ReportDutyManagerMr.Compliance + "');";
        }

        if (Name.Equals("MR Reception") && Version.ToString() == "1") // MR Reception Version 1
        {
            insertQuery = "INSERT INTO " + Table + " (ReportId, RCatId, StaffId, StaffName, ShiftId, ShiftDate, ShiftDOW, EntryDate, AuditVersion, Report_Table, Report_Version, ModifyDate, ReportStat, ReadByList, Comments, SignInSlip, Refusals, EventsField, GeneralComments) " +
                "VALUES(" + Id + ", 6, " + SelectedStaffId + ", '" + SelectedStaffName + "' ," + ShiftId + ", (CONVERT(DateTime,'" + ShiftDate + "',103)), '" + ShiftDOW + "', (CONVERT(DateTime,'" + EntryDate + "',103)), " + AuditVersion + ", 'rptMRRec', 1, current_timestamp, 'Awaiting Completion', ',' + '" + UserCredentials.StaffId + "' + ',', '" + Report.Comment + "', '" + ReportReceptionMr.SignIn + "', '" + ReportReceptionMr.Refusals + "', '" + ReportReceptionMr.Events + "', '" + ReportReceptionMr.GenComm + "');";
        }

        if (Name.Equals("CU Reception") && Version.ToString() == "1") // MR Reception Version 1
        {
            insertQuery = "INSERT INTO " + Table + " (ReportId, RCatId, StaffId, StaffName, ShiftId, ShiftDate, ShiftDOW, EntryDate, AuditVersion, Report_Table, Report_Version, ModifyDate, ReportStat, ReadByList, Comments, SignInSlip, Refusals, EventsField, GeneralComments) " +
                "VALUES(" + Id + ", 8, " + SelectedStaffId + ", '" + SelectedStaffName + "' ," + ShiftId + ", (CONVERT(DateTime,'" + ShiftDate + "',103)), '" + ShiftDOW + "', (CONVERT(DateTime,'" + EntryDate + "',103)), " + AuditVersion + ", 'rptUMRec', 1, current_timestamp, 'Awaiting Completion', ',' + '" + UserCredentials.StaffId + "' + ',', '" + Report.Comment + "', '" + ReportReceptionCu.SignIn + "', '" + ReportReceptionCu.Refusals + "', '" + ReportReceptionCu.Events + "', '" + ReportReceptionCu.GenComm + "');";
        }

        if (Name.Equals("MR Reception Supervisor") && Version.ToString() == "1") // MR Reception Supervisor Version 1
        {
            insertQuery = "INSERT INTO " + Table + " (ReportId, RCatId, StaffId, StaffName, ShiftId, ShiftDate, ShiftDOW, EntryDate, AuditVersion, Report_Table, Report_Version, ModifyDate, ReportStat, ReadByList, Comments, SignInSlip, Refusals, EventsField, GeneralComments) " +
                "VALUES(" + Id + ", 5, " + SelectedStaffId + ", '" + SelectedStaffName + "' ," + ShiftId + ", (CONVERT(DateTime,'" + ShiftDate + "',103)), '" + ShiftDOW + "', (CONVERT(DateTime,'" + EntryDate + "',103)), " + AuditVersion + ", 'rptMRRecSup', 1, current_timestamp, 'Awaiting Completion', ',' + '" + UserCredentials.StaffId + "' + ',', '" + Report.Comment + "', '" + ReportReceptionSupervisorMr.SignIn + "', '" + ReportReceptionSupervisorMr.Refusals + "', '" + ReportReceptionSupervisorMr.Events + "', '" + ReportReceptionSupervisorMr.GenComm + "');";
        }

        if (Name.Equals("MR Supervisors") && Version.ToString() == "1") // MR Supervisor Version 1
        {
            insertQuery = "INSERT INTO " + Table + " (ReportId, RCatId, StaffId, StaffName, ShiftId, ShiftDate, ShiftDOW, EntryDate, AuditVersion, Report_Table, Report_Version, ModifyDate, ReportStat, ReadByList, Comments, SignInSlip, Reception, Gaming, Bar, TABKeno, HouseKeeping, Bistro, FoodHygiene, Events, CustomerService, GeneralComments, LuckyRewards, RSA, AMLCTF) " +
                "VALUES(" + Id + ", 3, " + SelectedStaffId + ", '" + SelectedStaffName + "' ," + ShiftId + ", (CONVERT(DateTime,'" + ShiftDate + "',103)), '" + ShiftDOW + "', (CONVERT(DateTime,'" + EntryDate + "',103)), " + AuditVersion + ", 'rptMRSup', 1, current_timestamp, 'Awaiting Completion', ',' + '" + UserCredentials.StaffId + "' + ',', '" + Report.Comment + "', '" + ReportSupervisorMr.SignInSlip + "', '" + ReportSupervisorMr.Reception + "', '" + ReportSupervisorMr.Gaming + "', '" + ReportSupervisorMr.Bar + "', '" + ReportSupervisorMr.TabKeno +
                "', '" + ReportSupervisorMr.HouseKeeping + "', '" + ReportSupervisorMr.Bistro + "', '" + ReportSupervisorMr.FoodHygiene + "', '" + ReportSupervisorMr.Events + "', '" + ReportSupervisorMr.CustomerService + "', '" + ReportSupervisorMr.GenComm + "', '" + ReportSupervisorMr.LuckyRewards + "', '" + ReportSupervisorMr.RSA + "', '" + ReportSupervisorMr.AMLCTF + "');";
        }

        if (Name.Equals("MR Function Supervisor") && Version.ToString() == "1") // MR Function Supervisor Version 1
        {
            insertQuery = "INSERT INTO " + Table + " (ReportId, RCatId, StaffId, StaffName, ShiftId, ShiftDate, ShiftDOW, EntryDate, AuditVersion, Report_Table, Report_Version, ModifyDate, ReportStat, ReadByList, Comments, FunctionName, NumberOfGuests, Setup, MenuFeedback, BarFeedback, StaffIssues, GeneralComments) " +
                "VALUES(" + Id + ", 4, " + SelectedStaffId + ", '" + SelectedStaffName + "' ," + ShiftId + ", (CONVERT(DateTime,'" + ShiftDate + "',103)), '" + ShiftDOW + "', (CONVERT(DateTime,'" + EntryDate + "',103)), " + AuditVersion + ", 'rptMRFuncSup', 1, current_timestamp, 'Awaiting Completion', ',' + '" + UserCredentials.StaffId + "' + ',', '" + Report.Comment + "', '" + ReportFunctionSupervisorMr.FunctionName + "', '" + ReportFunctionSupervisorMr.NoOfGuests + "', '" + ReportFunctionSupervisorMr.Setup + "', '" + ReportFunctionSupervisorMr.MenuFeed +
                "', '" + ReportFunctionSupervisorMr.BarFeed + "', '" + ReportFunctionSupervisorMr.StaffIss + "', '" + ReportFunctionSupervisorMr.GenComm + "');";
        }
    ...
    public static string UpdateQuery()
    {
        ...
        if (Name.Equals("CU Incident Report") && Version.ToString() == "1") // UM Incident Report Version 1
        {
            updateQuery = "UPDATE " + Table + " SET ModifyDate=current_timestamp, ShiftId='" + ShiftId + "', ShiftDate=(CONVERT(DateTime,'" + ShiftDate + "',103)), ShiftDOW='" + ShiftDOW + "', NoOfPerson=" + ReportIncidentCu.NoOfPerson + ", FirstName1='" + ReportIncidentCu.First1 + "', LastName1='" + ReportIncidentCu.Last1 + "', Contact1='" + ReportIncidentCu.Contact1 + "', PartyType1='" + ReportIncidentCu.Type1 + "', Witness1='" + ReportIncidentCu.Witness1 + "'," +
                ...
                "', Alias5='" + ReportIncidentCu.Alias5 + "', MemberSince1='" + ReportIncidentCu.MemberSince1 + "', MemberSince2='" + ReportIncidentCu.MemberSince2 + "', MemberSince3='" + ReportIncidentCu.MemberSince3 + "', MemberSince4='" + ReportIncidentCu.MemberSince4 + "', MemberSince5='" + ReportIncidentCu.MemberSince5 + "' WHERE ReportId='" + Id + "' AND AuditVersion='" + AuditVersion + "'";
        }
        ...
        if (Name.Equals("MR Duty Managers") && Version.ToString() == "1") // MR Duty Managers Version 1
        {
            updateQuery = "UPDATE " + Table + " SET ModifyDate=current_timestamp, ShiftId='" + ShiftId + "', ShiftDate=(CONVERT(DateTime,'" + ShiftDate + "',103)), ShiftDOW='" + ShiftDOW + "', Supervisors='" + ReportDutyManagerMr.Sup + "', Whs='" + ReportDutyManagerMr.Whs + "', CostSavings='" + ReportDutyManagerMr.Cost + "', ClubPresent='" + ReportDutyManagerMr.ClubPres + "'," +
                ...
                " Cameras='" + ReportDutyManagerMr.Cameras + "', GeneralComments='" + ReportDutyManagerMr.GenComm + "', LuckyRewards='" + ReportDutyManagerMr.LuckyRewards + "', Compliance='" + ReportDutyManagerMr.Compliance + "'  WHERE ReportId='" + Id + "' AND AuditVersion='" + AuditVersion + "'";
        }
        ...
        if (Name.Equals("CU Duty Managers") && Version.ToString() == "1") // UM Duty Managers Version 1
        {
            updateQuery = "UPDATE " + Table + " SET ModifyDate=current_timestamp, ShiftId='" + ShiftId + "', ShiftDate=(CONVERT(DateTime,'" + ShiftDate + "',103)), ShiftDOW='" + ShiftDOW + "', Supervisors='" + ReportDutyManagerCu.Sup + "', Whs='" + ReportDutyManagerCu.Whs + "', CostSavings='" + ReportDutyManagerCu.Cost + "', ClubPresent='" + ReportDutyManagerCu.ClubPres + "'," +
                ...
                " Cameras='" + ReportDutyManagerCu.Cameras + "', GeneralComments='" + ReportDutyManagerCu.GenComm + "', LuckyRewards='" + ReportDutyManagerCu.LuckyRewards + "', Compliance='" + ReportDutyManagerCu.Compliance + "'  WHERE ReportId='" + Id + "' AND AuditVersion='" + AuditVersion + "'";
        }
        ...
        if (Name.Equals("MR Supervisors") && Version.ToString() == "1") // MR Supervisors Version 1
        {
            updateQuery = "UPDATE " + Table + " SET ModifyDate=current_timestamp, ShiftId='" + ShiftId + "', ShiftDate=(CONVERT(DateTime,'" + ShiftDate + "',103)), ShiftDOW='" + ShiftDOW + "', SignInSlip='" + ReportSupervisorMr.SignInSlip + "', Reception='" + ReportSupervisorMr.Reception + "', Gaming='" + ReportSupervisorMr.Gaming + "', Bar='" + ReportSupervisorMr.Bar + "'," +
                ...
                " CustomerService='" + ReportSupervisorMr.CustomerService + "', GeneralComments='" + ReportSupervisorMr.GenComm + "', LuckyRewards='" + ReportSupervisorMr.LuckyRewards + "', RSA='" + ReportSupervisorMr.RSA + "', AMLCTF='" + ReportSupervisorMr.AMLCTF + "'  WHERE ReportId='" + Id + "' AND AuditVersion='" + AuditVersion + "'";
        }

        if (Name.Equals("MR Reception") && Version.ToString() == "1") // MR Reception Version 1
        {
            updateQuery = "UPDATE " + Table + " SET ModifyDate=current_timestamp, ShiftId='" + ShiftId + "', ShiftDate=(CONVERT(DateTime,'" + ShiftDate + "',103)), ShiftDOW='" + ShiftDOW + "', SignInSlip='" + ReportReceptionMr.SignIn + "', Refusals='" + ReportReceptionMr.Refusals + "', EventsField='" + ReportReceptionMr.Events + "', GeneralComments='" + ReportReceptionMr.GenComm + "'  WHERE ReportId='" + Id + "' AND AuditVersion='" + AuditVersion + "'";
        }

        if (Name.Equals("CU Reception") && Version.ToString() == "1") // UM Reception Version 1
        {
            updateQuery = "UPDATE " + Table + " SET ModifyDate=current_timestamp, ShiftId='" + ShiftId + "', ShiftDate=(CONVERT(DateTime,'" + ShiftDate + "',103)), ShiftDOW='" + ShiftDOW + "', SignInSlip='" + ReportReceptionCu.SignIn + "', Refusals='" + ReportReceptionCu.Refusals + "', EventsField='" + ReportReceptionCu.Events + "', GeneralComments='" + ReportReceptionCu.GenComm + "'  WHERE ReportId='" + Id + "' AND AuditVersion='" + AuditVersion + "'";
        }
        ...
        if (Name.Equals("MR Function Supervisor") && Version.ToString() == "1") // MR Reception Version 1
        {
            updateQuery = "UPDATE " + Table + " SET ModifyDate=current_timestamp, ShiftId='" + ShiftId + "', ShiftDate=(CONVERT(DateTime,'" + ShiftDate + "',103)), ShiftDOW='" + ShiftDOW + "', FunctionName='" + ReportFunctionSupervisorMr.FunctionName + "', NumberOfGuests='" + ReportFunctionSupervisorMr.NoOfGuests + "', Setup='" + ReportFunctionSupervisorMr.Setup + "', MenuFeedback='" + ReportFunctionSupervisorMr.MenuFeed + "', BarFeedback='" + ReportFunctionSupervisorMr.BarFeed + "', StaffIssues='" + ReportFunctionSupervisorMr.StaffIss
                + "', GeneralComments='" + ReportFunctionSupervisorMr.GenComm + "'  WHERE ReportId='" + Id + "' AND AuditVersion='" + AuditVersion + "'";
        }

        if (Name.Equals("MR Reception Supervisor") && Version.ToString() == "1") // MR Reception Supervisor Version 1
        {
            updateQuery = "UPDATE " + Table + " SET ModifyDate=current_timestamp, ShiftId='" + ShiftId + "', ShiftDate=(CONVERT(DateTime,'" + ShiftDate + "',103)), ShiftDOW='" + ShiftDOW + "', SignInSlip='" + ReportReceptionSupervisorMr.SignIn + "', Refusals='" + ReportReceptionSupervisorMr.Refusals + "', EventsField='" + ReportReceptionSupervisorMr.Events + "', GeneralComments='" + ReportReceptionSupervisorMr.GenComm + "'  WHERE ReportId='" + Id + "' AND AuditVersion='" + AuditVersion + "'";
        }
        return updateQuery;
    }

    ...
    public static string InsertQuery()
    {
        ...
        if (Name.Equals("MR Incident Report") && Version == "1") // MR Incident Report Version 1
        {
            insertQuery = "INSERT INTO " + Table + " (ReportId, RCatId, StaffId, StaffName, ShiftId, ShiftDate, ShiftDOW, EntryDate, AuditVersion, Report_Table, Report_Version, ModifyDate, ReportStat, ReadByList, Comments, NoOfPerson, FirstName1, LastName1, Contact1, PartyType1, Witness1, MemberNo1, CardHeld1, SignInSlip1, SignedInBy1, PDate1," +
                ...
                " TxtTimeM, TxtTimeTC, PlayerId1, PlayerId2, PlayerId3, PlayerId4, PlayerId5, Alias1, Alias2, Alias3, Alias4, Alias5, MemberSince1, MemberSince2, MemberSince3, MemberSince4, MemberSince5) VALUES(" + Id + ", 1, " + SelectedStaffId + ", '" + SelectedStaffName + "' ," + ShiftId + ", (CONVERT(DateTime,'" + ShiftDate + "',103)), '" + ShiftDOW + "', (CONVERT(DateTime,'" + EntryDate + "',103)), " + AuditVersion + ", 'Report_MerrylandsRSLIncident', 1, current_timestamp, 'Awaiting Completion', ',' + '" + UserCredentials.StaffId + "' + ',', '" + Report.Comment + "', " + ReportIncidentMr.NoOfPerson + ", '" + ReportIncidentMr.First1 + "', '" + ReportIncidentMr.Last1 + "', '" + ReportIncidentMr.Contact1 + "', '" + ReportIncidentMr.Type1 + "', '" + ReportIncidentMr.Witness1 + "'," +
        ...
        if (Name.Equals("CU Incident Report") && Version == "1") // CU Incident Report Version 1
        {
            insertQuery = "INSERT INTO " + Table + " (ReportId, RCatId, StaffId, StaffName, ShiftId, ShiftDate, ShiftDOW, EntryDate, AuditVersion, Report_Table, Report_Version, ModifyDate, ReportStat, ReadByList, Comments, NoOfPerson, FirstName1, LastName1, Contact1, PartyType1, Witness1, MemberNo1, CardHeld1, SignInSlip1, SignedInBy1, PDate1," +
                ...
                " TxtCamETimeTC4, TxtCamSTimeH5, TxtCamSTimeM5, TxtCamSTimeTC5, TxtCamETimeH5, TxtCamETimeM5, TxtCamETimeTC5, TxtCamSTimeH6, TxtCamSTimeM6, TxtCamSTimeTC6," +
                " TxtCamETimeH6, TxtCamETimeM6, TxtCamETimeTC6, TxtCamSTimeH7, TxtCamSTimeM7, TxtCamSTimeTC7, TxtCamETimeH7, TxtCamETimeM7, TxtCamETimeTC7, TxtTimeH," +
                " TxtTimeM, TxtTimeTC, PlayerId1, PlayerId2, PlayerId3, PlayerId4, PlayerId5, Alias1, Alias2, Alias3, Alias4, Alias5, MemberSince1, MemberSince2, MemberSince3, MemberSince4, MemberSince5) VALUES(" + Id + ", 9, " + SelectedStaffId + ", '" + SelectedStaffName + "' ," + ShiftId + ", (CONVERT(DateTime,'" + ShiftDate + "',103)), '" + ShiftDOW + "', (CONVERT(DateTime,'" + EntryDate + "',103)), " + AuditVersion + ", 'Report_ClubUminaIncident', 1, current_timestamp, 'Awaiting Completion', ',' + '" + UserCredentials.StaffId + "' + ',', '" + Report.Comment + "', " + ReportIncidentCu.NoOfPerson + ", '" + ReportIncidentCu.First1 + "', '" + ReportIncidentCu.Last1 + "', '" + ReportIncidentCu.Contact1 + "', '" + ReportIncidentCu.Type1 + "', '" + ReportIncidentCu.Witness1 + "'," +
        ...
        if (Name.Equals("CU Duty Managers") && Version.ToString() == "1") // CU Duty Manager Version 1
        {
            insertQuery = "INSERT INTO " + Table + " (ReportId, RCatId, StaffId, StaffName, ShiftId, ShiftDate, ShiftDOW, EntryDate, AuditVersion, Report_Table, Report_Version, ModifyDate, ReportStat, ReadByList, Comments, Supervisors, Whs, CostSavings, ClubPresent, ClubMaintenance, Absenteeism, StaffIssues, Gaming, KeySecurity, Cameras, GeneralComments," +
                " LuckyRewards, Compliance) VALUES(" + Id + ", 7, " + SelectedStaffId + ", '" + SelectedStaffName + "' ," + ShiftId + ", (CONVERT(DateTime,'" + ShiftDate + "',103)), '" + ShiftDOW + "', (CONVERT(DateTime,'" + EntryDate + "',103)), " + AuditVersion + ", 'Report_ClubUminaDutyManager', 1, current_timestamp, 'Awaiting Completion', ',' + '" + UserCredentials.StaffId + "' + ',', '" + Report.Comment + "', '" + ReportDutyManagerCu.Sup + "', '" + ReportDutyManagerCu.Whs + "', '" + ReportDutyManagerCu.Cost + "', '" + ReportDutyManagerCu.ClubPres + "', '" + ReportDutyManagerCu.ClubMain + "', '" + ReportDutyManagerCu.Absent + "'," +
        ...
        {
            insertQuery = "INSERT INTO " + Table + " (ReportId, RCatId, StaffId, StaffName, ShiftId, ShiftDate, ShiftDOW, EntryDate, AuditVersion, Report_Table, Report_Version, ModifyDate, ReportStat, ReadByList, Comments, Supervisors, Whs, CostSavings, ClubPresent, ClubMaintenance, Absenteeism, StaffIssues, Gaming, KeySecurity, Cameras, GeneralComments," +
                " LuckyRewards, Compliance) VALUES(" + Id + ", 2, " + SelectedStaffId + ", '" + SelectedStaffName + "' ," + ShiftId + ", (CONVERT(DateTime,'" + ShiftDate + "',103)), '" + ShiftDOW + "', (CONVERT(DateTime,'" + EntryDate + "',103)), " + AuditVersion + ", 'Report_MerrylandsRSLDutyManager', 1, current_timestamp, 'Awaiting Completion', ',' + '" + UserCredentials.StaffId + "' + ',', '" + Report.Comment + "', '" + ReportDutyManagerMr.Sup + "', '" + ReportDutyManagerMr.Whs + "', '" + ReportDutyManagerMr.Cost + "', '" + ReportDutyManagerMr.ClubPres + "', '" + ReportDutyManagerMr.ClubMain + "', '" + ReportDutyManagerMr.Absent + "'," +
        ...
        if (Name.Equals("MR Reception") && Version.ToString() == "1") // MR Reception Version 1
        {
            insertQuery = "INSERT INTO " + Table + " (ReportId, RCatId, StaffId, StaffName, ShiftId, ShiftDate, ShiftDOW, EntryDate, AuditVersion, Report_Table, Report_Version, ModifyDate, ReportStat, ReadByList, Comments, SignInSlip, Refusals, EventsField, GeneralComments) " +
                "VALUES(" + Id + ", 6, " + SelectedStaffId + ", '" + SelectedStaffName + "' ," + ShiftId + ", (CONVERT(DateTime,'" + ShiftDate + "',103)), '" + ShiftDOW + "', (CONVERT(DateTime,'" + EntryDate + "',103)), " + AuditVersion + ", 'Report_MerrylandsRSLReception', 1, current_timestamp, 'Awaiting Completion', ',' + '" + UserCredentials.StaffId + "' + ',', '" + Report.Comment + "', '" + ReportReceptionMr.SignIn + "', '" + ReportReceptionMr.Refusals + "', '" + ReportReceptionMr.Events + "', '" + ReportReceptionMr.GenComm + "');";
        }

        if (Name.Equals("CU Reception") && Version.ToString() == "1") // MR Reception Version 1
        {
            insertQuery = "INSERT INTO " + Table + " (ReportId, RCatId, StaffId, StaffName, ShiftId, ShiftDate, ShiftDOW, EntryDate, AuditVersion, Report_Table, Report_Version, ModifyDate, ReportStat, ReadByList, Comments, SignInSlip, Refusals, EventsField, GeneralComments) " +
                "VALUES(" + Id + ", 8, " + SelectedStaffId + ", '" + SelectedStaffName + "' ," + ShiftId + ", (CONVERT(DateTime,'" + ShiftDate + "',103)), '" + ShiftDOW + "', (CONVERT(DateTime,'" + EntryDate + "',103)), " + AuditVersion + ", 'Report_ClubUminaReception', 1, current_timestamp, 'Awaiting Completion', ',' + '" + UserCredentials.StaffId + "' + ',', '" + Report.Comment + "', '" + ReportReceptionCu.SignIn + "', '" + ReportReceptionCu.Refusals + "', '" + ReportReceptionCu.Events + "', '" + ReportReceptionCu.GenComm + "');";
        }

        if (Name.Equals("MR Reception Supervisor") && Version.ToString() == "1") // MR Reception Supervisor Version 1
        {
            insertQuery = "INSERT INTO " + Table + " (ReportId, RCatId, StaffId, StaffName, ShiftId, ShiftDate, ShiftDOW, EntryDate, AuditVersion, Report_Table, Report_Version, ModifyDate, ReportStat, ReadByList, Comments, SignInSlip, Refusals, EventsField, GeneralComments) " +
                "VALUES(" + Id + ", 5, " + SelectedStaffId + ", '" + SelectedStaffName + "' ," + ShiftId + ", (CONVERT(DateTime,'" + ShiftDate + "',103)), '" + ShiftDOW + "', (CONVERT(DateTime,'" + EntryDate + "',103)), " + AuditVersion + ", 'Report_MerrylandsRSLReceptionSupervisor', 1, current_timestamp, 'Awaiting Completion', ',' + '" + UserCredentials.StaffId + "' + ',', '" + Report.Comment + "', '" + ReportReceptionSupervisorMr.SignIn + "', '" + ReportReceptionSupervisorMr.Refusals + "', '" + ReportReceptionSupervisorMr.Events + "', '" + ReportReceptionSupervisorMr.GenComm + "');";
        }

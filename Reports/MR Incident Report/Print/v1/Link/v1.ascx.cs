...
public partial class Reports_MR_Incident_Report_Print_v1_Link_v1 : System.Web.UI.UserControl
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            if (Report.SelectedStaffId == UserCredentials.StaffId || UserCredentials.GroupsQuery.Contains("Supervisor") || UserCredentials.GroupsQuery.Contains("Duty Manager") && Report.LinkedTable.Contains("Incident")) // if it is a member of Duty Manager display the Incident Report
            {

<%@ Control Language="C#" AutoEventWireup="true" CodeFile="v1.ascx.cs" Inherits="Reports_MR_Incident_Report_View_v1_Link_v1" %>
<div class="table-link-view">
    <div>
        <span style="margin-left: 0%; font-size: 18px; width: 130px;">STATUS: <%# Eval("ReportStat") %></span>
        <span class="reportNo"><%# Eval("ReportName") %> ID No. <span style="color: red;"><b><%# Eval("ReportId") %></b></span></span>
    </div>
        ...
        <table id="tblPerson1" class="table-view" runat="server">
            ...
            <tr>
                ...
                <td id="member11l" runat="server" visible="false" colspan="1"><b>Member No : </b>
                    <br />
                    <asp:LinkButton ID="LinkButton1" runat="server" OnClientClick="window.open('/Default.aspx?ReportType=&DateGroup=&ReportStatus=&Keyword=&Staff=&PlayerId=mr1', null, 'channelmode=1, width=1366,height=768,resizable=yes,status=no,toolbar=no,scrollbars=yes,menubar=yes,location=no,left=1,top=1' );return false;" ><%# Eval("MemberNo1") %></asp:LinkButton>
                </td>
        ...
        <table id="tblPerson2" class="table-view" runat="server">
            ...
            <tr>
                ...
                <td id="member21l" runat="server" visible="false" colspan="1"><b>Member No : </b>
                    <br />
                    <asp:LinkButton ID="LinkButton2" runat="server" OnClientClick="window.open('/Default.aspx?ReportType=&DateGroup=&ReportStatus=&Keyword=&Staff=&PlayerId=mr2', null, 'channelmode=1, width=1366,height=768,resizable=yes,status=no,toolbar=no,scrollbars=yes,menubar=yes,location=no,left=1,top=1' );return false;" ><%# Eval("MemberNo2") %></asp:LinkButton>
                </td>
        ...
        <table id="tblPerson3" class="table-view" runat="server">
            ...
            <tr>
                ...
                <td id="member31l" runat="server" visible="false" colspan="1"><b>Member No : </b>
                    <br />
                    <asp:LinkButton ID="LinkButton3" runat="server" OnClientClick="window.open('/Default.aspx?ReportType=&DateGroup=&ReportStatus=&Keyword=&Staff=&PlayerId=mr3', null, 'channelmode=1, width=1366,height=768,resizable=yes,status=no,toolbar=no,scrollbars=yes,menubar=yes,location=no,left=1,top=1' );return false;" ><%# Eval("MemberNo3") %></asp:LinkButton>
                </td>
        ...
        <table id="tblPerson4" class="table-view" runat="server">
            ...
            <tr>
                ...
                <td id="member41l" runat="server" visible="false" colspan="1"><b>Member No : </b>
                    <br />
                    <asp:LinkButton ID="LinkButton4" runat="server" OnClientClick="window.open('/Default.aspx?ReportType=&DateGroup=&ReportStatus=&Keyword=&Staff=&PlayerId=mr4', null, 'channelmode=1, width=1366,height=768,resizable=yes,status=no,toolbar=no,scrollbars=yes,menubar=yes,location=no,left=1,top=1' );return false;" ><%# Eval("MemberNo4") %></asp:LinkButton>
                </td>
        ...
        <table id="tblPerson5" class="table-view" runat="server">
            ...
            <tr>
                ...
                <td id="member51l" runat="server" visible="false" colspan="1"><b>Member No : </b>
                    <br />
                    <asp:LinkButton ID="LinkButton5" runat="server" OnClientClick="window.open('/Default.aspx?ReportType=&DateGroup=&ReportStatus=&Keyword=&Staff=&PlayerId=mr5', null, 'channelmode=1, width=1366,height=768,resizable=yes,status=no,toolbar=no,scrollbars=yes,menubar=yes,location=no,left=1,top=1' );return false;" ><%# Eval("MemberNo5") %></asp:LinkButton>
                </td>
                ...
                <asp:GridView runat="server" ID="gvRecommendation_DisciplinaryAction" HeaderStyle-CssClass="gvHeader" Style="table-layout: fixed;" Width="100%" DataKeyNames="id"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Statement" ItemStyle-Width="500" ItemStyle-HorizontalAlign="Center">
                            ...
                            <EditItemTemplate>
                                <asp:TextBox ID="txtStatement" CSSClass="form-control" TextMode="MultiLine" Height="50" runat="server" Text='<%# Bind("Statement") %>' />
                            </EditItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Date Entered" HeaderStyle-Width="150px" ItemStyle-HorizontalAlign="Center">
                            <ItemTemplate>
                ...
                <asp:GridView runat="server" ID="gvRecommendation_Judiciary" HeaderStyle-CssClass="gvHeader" Style="table-layout: fixed;" Width="100%" DataKeyNames="id"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Decision" ItemStyle-Width="500" ItemStyle-HorizontalAlign="Center">
                            ...
                            <EditItemTemplate>
                                <asp:TextBox ID="txtDecision" CSSClass="form-control" TextMode="MultiLine" Height="50" runat="server" Text='<%# Bind("Decision") %>' />
                            </EditItemTemplate>
                        </asp:TemplateField>

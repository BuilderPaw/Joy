<%@ Control Language="C#" AutoEventWireup="true" CodeFile="v1.ascx.cs" Inherits="Reports_MR_Customer_Relations_Officer_Edit_v1_v1" %>
...
<div class="body3">
    ...
    <table class="table-incident">
        ...
        <tr>
            <td colspan="4">
                <asp:TextBox ID="txtGaming" class="object-default" OnTextChanged="TextChanged_TextChanged" runat="server" Height="130px" TextMode="MultiLine" Text="" Style="resize: none;"></asp:TextBox>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td colspan="4">
                <asp:TextBox ID="txtPromotions" class="object-default" OnTextChanged="TextChanged_TextChanged" TextMode="MultiLine" runat="server" Height="130px" Text="" Style="resize: none;"></asp:TextBox>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td colspan="4">
                <asp:TextBox ID="txtNewCustomers" class="object-default" OnTextChanged="TextChanged_TextChanged" TextMode="MultiLine" runat="server" Height="130px" Text="" Style="resize: none;"></asp:TextBox>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td colspan="4">
                <asp:TextBox ID="txtMemberContacts" class="object-default" OnTextChanged="TextChanged_TextChanged" TextMode="MultiLine" runat="server" Height="130px" Text="" Style="resize: none;"></asp:TextBox>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td colspan="4">
                <asp:TextBox ID="txtCustomerFollow" class="object-default" OnTextChanged="TextChanged_TextChanged" runat="server" Height="130px" Style="resize: none;" TextMode="MultiLine"></asp:TextBox>
            </td>
        </tr>
        <tr>

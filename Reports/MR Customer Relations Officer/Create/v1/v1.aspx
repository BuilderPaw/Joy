<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="v1.aspx.cs" Inherits="Reports_MR_Customer_Relations_Officer_Create_v1_v1" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="body">
        <br />
        <h4 style="margin-left: 8%;">MR Customer Relations Officer Report</h4>
        <table class="table-create-report">
            ...
            <tr>
                <td colspan="4">
                    <asp:TextBox ID="txtGaming" class="object-default" runat="server" Height="130px" TextMode="MultiLine" Style="resize: none;"></asp:TextBox>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td colspan="4">
                    <asp:TextBox ID="txtPromotions" class="object-default" runat="server" Height="130px" Style="resize: none;" TextMode="MultiLine"></asp:TextBox>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td colspan="4">
                    <asp:TextBox ID="txtNewCustomers" class="object-default" runat="server" Height="130px" Style="resize: none;" TextMode="MultiLine"></asp:TextBox>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td colspan="4">
                    <asp:TextBox ID="txtMemberContacts" class="object-default" runat="server" Height="130px" Style="resize: none;" TextMode="MultiLine"></asp:TextBox>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td colspan="4">
                    <asp:TextBox ID="txtCustomerFollow" class="object-default" runat="server" Height="130px" Style="resize: none;" TextMode="MultiLine"></asp:TextBox>
                </td>
            </tr>
            <tr>

...
public partial class Reports_MR_Customer_Relations_Officer_Create_v1_v1 : System.Web.UI.Page
{
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        string query = "SELECT MAX(ReportId) AS ReportId FROM dbo.Report_MerrylandsRSLCustomerRelationsOfficer";
        ...
        {
            Report_MerrylandsRSLCustomerRelationsOfficer dm = new Report_MerrylandsRSLCustomerRelationsOfficer();
            dm.ReportId = Int32.Parse(Report.LastReportId);
            dm.RCatId = 12; // Customer Relations Officer Category
            ...
            dm.Report_Table = "Report_MerrylandsRSLCustomerRelationsOfficer";
            dm.AuditVersion = 1;
            ...
            dm.Promotions = txtPromotions.Text.Replace("\n", "<br />").Replace("'", "^");
            dm.NewCustomers = txtNewCustomers.Text.Replace("\n", "<br />").Replace("'", "^");
            dm.MemberContacts = txtMemberContacts.Text.Replace("\n", "<br />").Replace("'", "^");
            dm.CustomerFeedback = txtCustomerFeedback.Text.Replace("\n", "<br />").Replace("'", "^");
            dm.CustomerFollow = txtCustomerFollow.Text.Replace("\n", "<br />").Replace("'", "^");
            dm.Maintenance = txtMaintenance.Text.Replace("\n", "<br />").Replace("'", "^");
            dm.GeneralComments = txtGeneralComments.Text.Replace("\n", "<br />").Replace("'", "^");
            dc.Report_MerrylandsRSLCustomerRelationsOfficers.InsertOnSubmit(dm);
            dc.SubmitChanges();
        }
    ...
    protected void btnReset_Click(object sender, EventArgs e)
    {
        txtGaming.Text = "";
        txtPromotions.Text = "";
        txtNewCustomers.Text = "";
        txtMemberContacts.Text = "";
        txtCustomerFeedback.Text = "";
        txtCustomerFollow.Text = "";
        txtMaintenance.Text = "";

<%@ Control Language="C#" AutoEventWireup="true" CodeFile="v1.ascx.cs" Inherits="Reports_MR_Gaming_Services_Print_v1_Active_v1" %>
        ...
        <table style="width: 100%; font-family: Arial; border: solid 1px black !important;">
            ...
            <tr>
                <td style="font-size: 12.5px;" colspan="4">
                    <%# (string.IsNullOrWhiteSpace(Eval("HarmMinimisation").ToString())) ? Eval("HarmMinimisation") : (Eval("HarmMinimisation").ToString()).Replace("^", "'") %>                                    
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td style="font-size: 12.5px;" colspan="4">
                    <%# (string.IsNullOrWhiteSpace(Eval("PromotionalAwareness").ToString())) ? Eval("PromotionalAwareness") : (Eval("PromotionalAwareness").ToString()).Replace("^", "'") %>                                    
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td style="font-size: 12.5px;" colspan="4">
                    <%# (string.IsNullOrWhiteSpace(Eval("SipAndChill").ToString())) ? Eval("SipAndChill") : (Eval("SipAndChill").ToString()).Replace("^", "'") %>                                    
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td style="font-size: 12.5px;" colspan="4">
                    <%# (string.IsNullOrWhiteSpace(Eval("CustomerComplaints").ToString())) ? Eval("CustomerComplaints") : (Eval("CustomerComplaints").ToString()).Replace("^", "'") %>                                    
                </td>
            </tr>            
            <tr>
            ...
            <tr>
                <td style="font-size: 12.5px;" colspan="4">
                    <%# (string.IsNullOrWhiteSpace(Eval("Incidents").ToString())) ? Eval("Incidents") : (Eval("Incidents").ToString()).Replace("^", "'") %>                                    
                </td>
            </tr>
            <tr>

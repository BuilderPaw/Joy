...
public partial class Reports_CU_Duty_Managers_Edit_v2_v2 : System.Web.UI.UserControl
{
            ...
            if (rdr.HasRows)
            {
                while (rdr.Read())
                {
                    if (method.Equals("getFields"))
                    {
                        ...
                        txtSpecialComments.Text = rdr["SpecialComments"].ToString().Replace("<br />", "\n").Replace("^", "'");
                    ...
                    if (method.Equals("checkChanges"))
                    {
                        ...
                        if (ReportDutyManagerCu.Sup != rdr["Supervisors"].ToString())
                        {
                            Report.HasChange = true; flag = 1;
                            Report.WhereChangeHappened = "Supervisors";
                        }
                        if (ReportDutyManagerCu.Whs != rdr["Whs"].ToString())
                        {
                            Report.HasChange = true; flag = 1;
                            Report.WhereChangeHappened = "Whs";
                        }
                        if (ReportDutyManagerCu.Cost != rdr["CostSavings"].ToString())
                        {
                            Report.HasChange = true; flag = 1;
                            Report.WhereChangeHappened = "CostSavings";
                        }
                        if (ReportDutyManagerCu.ClubPres != rdr["ClubPresent"].ToString())
                        {
                            Report.HasChange = true; flag = 1;
                            Report.WhereChangeHappened = "ClubPresent";
                        }
                        if (ReportDutyManagerCu.ClubMain != rdr["ClubMaintenance"].ToString())
                        {
                            Report.HasChange = true; flag = 1;
                            Report.WhereChangeHappened = "ClubMaintenance";
                        }
                        if (ReportDutyManagerCu.Absent != rdr["Absenteeism"].ToString())
                        {
                            Report.HasChange = true; flag = 1;
                            Report.WhereChangeHappened = "Absenteeism";
                        }
                        if (ReportDutyManagerCu.StaffIssues != rdr["StaffIssues"].ToString())
                        {
                            Report.HasChange = true; flag = 1;
                            Report.WhereChangeHappened = "StaffIssues";
                        }
                        if (ReportDutyManagerCu.Gaming != rdr["Gaming"].ToString())
                        {
                            Report.HasChange = true; flag = 1;
                            Report.WhereChangeHappened = "Gaming";
                        }
                        if (ReportDutyManagerCu.KeySec != rdr["KeySecurity"].ToString())
                        {
                            Report.HasChange = true; flag = 1;
                            Report.WhereChangeHappened = "KeySecurity";
                        }
                        if (ReportDutyManagerCu.Cameras != rdr["Cameras"].ToString())
                        {
                            Report.HasChange = true; flag = 1;
                            Report.WhereChangeHappened = "Cameras";
                        }
                        if (ReportDutyManagerCu.GenComm != rdr["GeneralComments"].ToString())
                        {
                            Report.HasChange = true; flag = 1;
                            Report.WhereChangeHappened = "GeneralComments";
                        }
                        if (ReportDutyManagerCu.LuckyRewards != rdr["LuckyRewards"].ToString())
                        {
                            Report.HasChange = true; flag = 1;
                            Report.WhereChangeHappened = "LuckyRewards";
                        }
                        if (ReportDutyManagerCu.Compliance != rdr["Compliance"].ToString())
                        {
                            Report.HasChange = true; flag = 1;
                            Report.WhereChangeHappened = "Compliance";
                        }
                        if (ReportDutyManagerCu.SpecialComments != rdr["SpecialComments"].ToString())
                        {
                            Report.HasChange = true; flag = 1;
                            Report.WhereChangeHappened = "SpecialComments";
                        }
                        if (flag == 0)
                        {
    ...
    protected void SetStaticVariable()
    {
        ...
        ReportDutyManagerCu.SpecialComments = txtSpecialComments.Text.Replace("\n", "<br />");
    }
}
<%@ Control Language="C#" AutoEventWireup="true" CodeFile="v2.ascx.cs" Inherits="Reports_CU_Duty_Managers_Edit_v2_v2" %>
...
<div class="body3">
    ...
    <table class="table-incident">
        ...
        <tr>
            <td colspan="4">
                <asp:TextBox ID="txtSupervisors" class="object-default" OnTextChanged="TextChanged_TextChanged" runat="server" Height="50px" TextMode="MultiLine" Text="" Style="resize: none;"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <th colspan="4">Bar</th>
        ...
        <tr>
            <td colspan="4">
                <asp:TextBox ID="txtGenComm" class="object-default" OnTextChanged="TextChanged_TextChanged" runat="server" Height="130px" Style="resize: none;" TextMode="MultiLine"></asp:TextBox>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td colspan="4">
                <asp:TextBox ID="txtLuckyRewards" class="object-default" OnTextChanged="TextChanged_TextChanged" runat="server" Height="130px" Style="resize: none;" TextMode="MultiLine"></asp:TextBox>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td colspan="4">
                <asp:TextBox ID="txtCompliance" class="object-default" OnTextChanged="TextChanged_TextChanged" runat="server" Height="130px" Style="resize: none;" TextMode="MultiLine"></asp:TextBox>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td colspan="4">
                <asp:TextBox ID="txtSpecialComments" class="object-default" OnTextChanged="TextChanged_TextChanged" runat="server" Height="130px" Style="resize: none;" TextMode="MultiLine"></asp:TextBox>
            </td>
        </tr>
    </table>
</div>

...
public partial class Reports_MR_Responsible_Gaming_Officer_Create_v1_v1 : System.Web.UI.Page
{
    ...
    protected void btnReset_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect("~/Reports/MR Responsible Gaming Officer/Create/v" + maxVersion.ToString() + "/v" + maxVersion.ToString() + ".aspx", false);
    }
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        string EventType = "", Location = "", RGONotified = "", PatronSigns = "", InitialAction = "", AlertResponse = "", PatronResponse = "", EventOutcome = "",
               query = "SELECT MAX(ReportId) AS ReportId FROM dbo.Report_MerrylandsRSLRGO";
        int lastRId;
        ...
        {
            Report_MerrylandsRSLRGO dm = new Report_MerrylandsRSLRGO();
            ...
            dm.Report_Table = "Report_MerrylandsRSLRGO";
            dm.AuditVersion = 1;
            ...
            if (ddlPartyType.SelectedItem.Value == "1")
            {
                dm.PlayerId = ReportResponsibleGamingOfficerMr.PlayerId;
            ...
            dc.Report_MerrylandsRSLRGOs.InsertOnSubmit(dm);
            dc.SubmitChanges();
        }
    ...
    protected void btnUserSign_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            con.Open();
            SqlCommand cmd = new SqlCommand("UPDATE Report_MerrylandsRSLRGO SET StaffSign='" + updateUserSign + "' WHERE ReportId='" + Report.LastReportId + "' AND AuditVersion='1'", con);
            cmd.ExecuteNonQuery();
            con.Close();

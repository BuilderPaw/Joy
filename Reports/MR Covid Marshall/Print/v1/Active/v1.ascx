<%@ Control Language="C#" AutoEventWireup="true" CodeFile="v1.ascx.cs" Inherits="Reports_MR_Covid_Marshall_Print_v1_Active_v1" %>
<div style="font-family: Arial; font-size: 12.5px;">
    <style type="text/css">
        th {
    ...
    <div class="table-link-view">
        ...
        <table style="margin-bottom: 35px; width: 100%; border-collapse: collapse; font-family: Arial; border: solid 1px black !important; font-size:12.5px;">
            <tr>
        ...
        <table style="margin-bottom: 35px; width: 100%; border-collapse: collapse;font-size:12.5px;">
            <tr>

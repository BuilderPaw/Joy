<%@ Control Language="C#" AutoEventWireup="true" CodeFile="v1.ascx.cs" Inherits="Reports_CU_Responsible_Gaming_Officer_Print_v1_Link_v1" %>
<div style="font-family: Arial">
    ...
    <h4 style="margin-left: 52%; font-family: Arial">CU RGO Event Report ID No. <span style="color: red;"><b><%# (string.IsNullOrWhiteSpace(Eval("ReportId").ToString())) ? Eval("ReportId") : (Eval("ReportId").ToString()).Replace("^", "'") %></b></span></h4>
    ...
    <div id="viewReport" runat="server">
        ...
        <table style="width: 100%; border: solid 1px black !important;">
            ...
            <tr>
                <th>Were Patron Details Recorded?</th>
            </tr>
            <tr>
                <td style="font-size: 12.5px;">
                    <b>Yes : </b>
        ...
        <table style="width: 100%; font-family: Arial; border: solid 1px black !important;" id="tbllistofsignsofproblemgambling" runat="server" visible="false">
            <tr>
            ...
            <tr>
                <td style="font-size: 12.5px" >
                    <asp:CheckBoxList ID="List_PatronSigns_GeneralWarningSigns_LengthOfPlay" RepeatLayout="table" RepeatColumns="3" Font-Size="8" RepeatDirection="vertical" runat="server" class="form-control" onclick="return false" readonly="true">
                    </asp:CheckBoxList>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td style="font-size: 12.5px" >
                    <asp:CheckBoxList ID="List_PatronSigns_GeneralWarningSigns_Money" RepeatLayout="table" RepeatColumns="2" Font-Size="8" RepeatDirection="vertical" runat="server" class="form-control" onclick="return false" readonly="true">
                    </asp:CheckBoxList>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td style="font-size: 12.5px" >
                    <asp:CheckBoxList ID="List_PatronSigns_GeneralWarningSigns_BehaviourDuringPlay" RepeatLayout="table" RepeatColumns="2" Font-Size="8" RepeatDirection="vertical" runat="server" class="form-control" onclick="return false" readonly="true">
                    </asp:CheckBoxList>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td style="font-size: 12.5px" >
                    <asp:CheckBoxList ID="List_PatronSigns_ProbableWarningSigns_LengthOfPlay" RepeatLayout="table" RepeatColumns="3" Font-Size="8" RepeatDirection="vertical" runat="server" class="form-control" onclick="return false" readonly="true">
                    </asp:CheckBoxList>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td style="font-size: 12.5px" >
                    <asp:CheckBoxList ID="List_PatronSigns_ProbableWarningSigns_Money" RepeatLayout="table" RepeatColumns="4" Font-Size="8" RepeatDirection="vertical" runat="server" class="form-control" onclick="return false" readonly="true">
                    </asp:CheckBoxList>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td style="font-size: 12.5px" >
                    <asp:CheckBoxList ID="List_PatronSigns_ProbableWarningSigns_BehaviourDuringPlay" RepeatLayout="table" RepeatColumns="1" Font-Size="8" RepeatDirection="vertical" runat="server" class="form-control" onclick="return false" readonly="true">
                    </asp:CheckBoxList>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td style="font-size: 12.5px" >
                    <asp:CheckBoxList ID="List_PatronSigns_ProbableWarningSigns_SocialBehaviours" RepeatLayout="table" RepeatColumns="3" Font-Size="8" RepeatDirection="vertical" runat="server" class="form-control" onclick="return false" readonly="true">
                    </asp:CheckBoxList>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td style="font-size: 12.5px" >
                    <asp:CheckBoxList ID="List_PatronSigns_StrongWarningSigns_LengthOfPlay" RepeatLayout="table" RepeatColumns="2" Font-Size="8" RepeatDirection="vertical" runat="server" class="form-control" onclick="return false" readonly="true">
                    </asp:CheckBoxList>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td style="font-size: 12.5px" >
                    <asp:CheckBoxList ID="List_PatronSigns_StrongWarningSigns_Money" RepeatLayout="table" RepeatColumns="2" Font-Size="8" RepeatDirection="vertical" runat="server" class="form-control" onclick="return false" readonly="true">
                    </asp:CheckBoxList>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td style="font-size: 12.5px" >
                    <asp:CheckBoxList ID="List_PatronSigns_StrongWarningSigns_BehaviourDuringPlay" RepeatLayout="table" RepeatColumns="2" Font-Size="8" RepeatDirection="vertical" runat="server" class="form-control" onclick="return false" readonly="true">
                    </asp:CheckBoxList>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td style="font-size: 12.5px" >
                    <asp:CheckBoxList ID="List_PatronSigns_StrongWarningSigns_SocialBehaviours" RepeatLayout="table" RepeatColumns="1" Font-Size="8" RepeatDirection="vertical" runat="server" class="form-control" onclick="return false" readonly="true">
                    </asp:CheckBoxList>
                </td>
            </tr>
        ...
        <table style="width: 100%; font-family: Arial; border: solid 1px black !important;">
            ...
            <tr>
                <td style="font-size: 12.5px" >
                    <asp:CheckBoxList ID="List_InitialAction" RepeatLayout="table" RepeatColumns="2" Font-Size="8" RepeatDirection="vertical" runat="server" class="form-control" onclick="return false" readonly="true">
                    </asp:CheckBoxList>
                </td>
            </tr>
        </table>
        ...
        <table style="width: 100%; font-family: Arial; border: solid 1px black !important;">
            ...
            <tr>
                <td style="font-size: 12.5px" >
                    <asp:CheckBoxList ID="List_PatronResponse" RepeatLayout="table" RepeatColumns="2" Font-Size="8" RepeatDirection="vertical" runat="server" class="form-control" onclick="return false" readonly="true">
                    </asp:CheckBoxList>
                </td>
            </tr>
        </table>
        <table style="width: 100%; font-family: Arial; border: solid 1px black !important;">
            ...
            <tr>
                <td style="font-size: 12.5px" >
                    <asp:CheckBoxList ID="List_EventOutcome" RepeatLayout="table" RepeatColumns="2" Font-Size="8" RepeatDirection="vertical" runat="server" class="form-control" onclick="return false" readonly="true">
                    </asp:CheckBoxList>
                </td>
            </tr>

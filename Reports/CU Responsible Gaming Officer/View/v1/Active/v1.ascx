<%@ Control Language="C#" AutoEventWireup="true" CodeFile="v1.ascx.cs" Inherits="Reports_CU_Responsible_Gaming_Officer_View_v1_Active_v1" %>
<div class="body2">
    <div>
        ...
        <span class="report-number">CU RGO Event Report ID No. <span style="color: red;"><b><%# (string.IsNullOrWhiteSpace(Eval("ReportId").ToString())) ? Eval("ReportId") : (Eval("ReportId").ToString()).Replace("^", "'") %></b></span></span>
    ...
    <div id="viewReport" runat="server">
        ...
        <table id="tblPerson1" class="table-view" visible="false" runat="server">
            <tr>

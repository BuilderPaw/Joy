<%@ Control Language="C#" AutoEventWireup="true" CodeFile="v1.ascx.cs" Inherits="Reports_CU_Responsible_Gaming_Officer_View_v1_Link_v1" %>
<div class="table-link-view">
    <div>
        ...
        <span class="reportNo">CU RGO Event Report ID No. <span style="color: red;"><b><%# (string.IsNullOrWhiteSpace(Eval("ReportId").ToString())) ? Eval("ReportId") : (Eval("ReportId").ToString()).Replace("^", "'") %></b></span></span>

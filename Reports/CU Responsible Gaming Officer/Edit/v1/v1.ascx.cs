...
public partial class Reports_CU_Responsible_Gaming_Officer_Edit_v1_v1 : System.Web.UI.UserControl
{
        ...
        try
        {
            ...
            if (rdr.HasRows)
            {
                while (rdr.Read())
                {
                    if (method.Equals("GetFields"))
                    {
                        ...
                        if (cbPatronDetailsRecorded.Checked == true)
                        {
                            ...
                            if (ddlPartyType.SelectedItem.Value == "1") // if person is a member, don't allow user to edit the following objects
                            {
                                ...
                                // member's fields
                                ReportResponsibleGamingOfficerCu.PlayerId = rdr["PlayerId"].ToString().Replace("<br />", "\n").Replace("^", "'");
                            ...
                            try // set Member Photo
                            {
                                if ((byte[])rdr["MemberPhoto"] != null)
                                {
                                    ...
                                    ReportResponsibleGamingOfficerCu.MemberPhoto = memberPhoto; // set global variable to current member photo
                                }
                            }
                            catch
                            {
                        ...
                        else
                        {
                            ...
                            cbPatronDetailsRecorded1.Checked = true;
                        }
                        ...
                        {
                            cbWitnessRecorded1.Checked = true;
                        }
                        ...
                        {
                            cbPoliceRecorded1.Checked = true;
                        }
                        ...
                        if (Convert.ToBoolean(rdr["IncidentReportCompleted"]) == true)
                        {
                            ...
                            {
                                cbAssistedCompletingIncidentReport1.Checked = true;
                            }
                        }
                        else
                        {
                            cbIncidentReportCompleted1.Checked = true;
                        }
                    }
                    ...
                    if (method.Equals("CheckChanges")) // check if there are any changes made in the report
                    {
                        ...
                        if (ReportResponsibleGamingOfficerCu.EventType.ToString() != rdr["EventType"].ToString())
                        {
                            Report.HasChange = true; flag = 1;
                            Report.WhereChangeHappened = "EventType";
                        }
                        if (ReportResponsibleGamingOfficerCu.EventTypeOther.ToString() != rdr["EventTypeOtherDesc"].ToString())
                        {
                            Report.HasChange = true; flag = 1;
                        ...
                        if (ReportResponsibleGamingOfficerCu.RGONotifiedOther.ToString() != rdr["RGONotifiedOther"].ToString())
                        {
                            Report.HasChange = true; flag = 1;
                            Report.WhereChangeHappened = "RGONotifiedOther";
                        }
                        if (ReportResponsibleGamingOfficerCu.PatronDetailsRecorded.ToString().ToLower() != Convert.ToBoolean(rdr["PatronDetailsRecorded"]).ToString().ToLower())
                        {
                            Report.HasChange = true; flag = 1;
                            Report.WhereChangeHappened = "PatronDetailsRecorded";
                        }
                        if (ReportResponsibleGamingOfficerCu.PartyType.ToString() != rdr["PartyType"].ToString())
                        {
                            Report.HasChange = true; flag = 1;
                            Report.WhereChangeHappened = "PartyType";
                        }
                        if (ReportResponsibleGamingOfficerCu.TxtPartyType.ToString() != rdr["TxtPartyType"].ToString())
                        {
                            Report.HasChange = true; flag = 1;
                            Report.WhereChangeHappened = "TxtPartyType";
                        }
                        if (ReportResponsibleGamingOfficerCu.PlayerId.ToString() != rdr["PlayerId"].ToString())
                        {
                            Report.HasChange = true; flag = 1;
                            Report.WhereChangeHappened = "PlayerId";
                        }
                        //if (ReportResponsibleGamingOfficerCu.MemberPhoto != (byte[])rdr["MemberPhoto"])
                        //{
                        //    Report.HasChange = true; flag = 1;
                        //    Report.WhereChangeHappened = "MemberPhoto";
                        //}
                        if (ReportResponsibleGamingOfficerCu.Member.ToString() != rdr["MemberNo"].ToString())
                        {
                            Report.HasChange = true; flag = 1;
                            Report.WhereChangeHappened = "MemberNumber";
                        }
                        if (ReportResponsibleGamingOfficerCu.First.ToString() != rdr["FirstName"].ToString())
                        {
                            Report.HasChange = true; flag = 1;
                            Report.WhereChangeHappened = "FirstName";
                        }
                        if (ReportResponsibleGamingOfficerCu.Last.ToString() != rdr["LastName"].ToString())
                        {
                            Report.HasChange = true; flag = 1;
                            Report.WhereChangeHappened = "LastName";
                        }
                        if (ReportResponsibleGamingOfficerCu.Alias.ToString() != rdr["Alias"].ToString())
                        {
                            Report.HasChange = true; flag = 1;
                            Report.WhereChangeHappened = "Alias";
                        }
                        if (ReportResponsibleGamingOfficerCu.Contact.ToString() != rdr["Contact"].ToString())
                        {
                            Report.HasChange = true; flag = 1;
                            Report.WhereChangeHappened = "Contact";
                        }
                        if (ReportResponsibleGamingOfficerCu.MemberSince.ToString() != rdr["MemberSince"].ToString())
                        {
                            Report.HasChange = true; flag = 1;
                            Report.WhereChangeHappened = "MemberSince";
                        }
                        if (ReportResponsibleGamingOfficerCu.MDOB.ToString() != rdr["MemberDOB"].ToString())
                        {
                            Report.HasChange = true; flag = 1;
                            Report.WhereChangeHappened = "MemberDOB";
                        }
                        if (ReportResponsibleGamingOfficerCu.MAddress.ToString() != rdr["MemberAddress"].ToString())
                        {
                            Report.HasChange = true; flag = 1;
                            Report.WhereChangeHappened = "MAddress";
                        }
                        if (ReportResponsibleGamingOfficerCu.SignInSlip.ToString().ToLower() != Convert.ToBoolean(rdr["SignInSlip"]).ToString().ToLower())
                        {
                            Report.HasChange = true; flag = 1;
                            Report.WhereChangeHappened = "SignInSlip";
                        }
                        if (ReportResponsibleGamingOfficerCu.SignInBy.ToString() != rdr["SignedInBy"].ToString())
                        {
                            Report.HasChange = true; flag = 1;
                            Report.WhereChangeHappened = "SignInBy";
                        }
                        if (ReportResponsibleGamingOfficerCu.VDOB.ToString() != rdr["VisitorDOB"].ToString())
                        {
                            Report.HasChange = true; flag = 1;
                            Report.WhereChangeHappened = "VisitorDOB";
                        }
                        if (ReportResponsibleGamingOfficerCu.VProofID.ToString() != rdr["VisitorProofID"].ToString())
                        {
                            Report.HasChange = true; flag = 1;
                            Report.WhereChangeHappened = "VProofID";
                        }
                        if (ReportResponsibleGamingOfficerCu.VAddress.ToString() != rdr["VisitorAddress"].ToString())
                        {
                            Report.HasChange = true; flag = 1;
                            Report.WhereChangeHappened = "VAddress";
                        }
                        if (ReportResponsibleGamingOfficerCu.Date.ToString() != rdr["Date"].ToString())
                        {
                            Report.HasChange = true; flag = 1;
                            Report.WhereChangeHappened = "Date";
                        }
                        if (ReportResponsibleGamingOfficerCu.Hour.ToString() != rdr["TimeH"].ToString())
                        {
                            Report.HasChange = true; flag = 1;
                            Report.WhereChangeHappened = "TimeH";
                        }
                        if (ReportResponsibleGamingOfficerCu.Minute.ToString() != rdr["TimeM"].ToString())
                        {
                            Report.HasChange = true; flag = 1;
                            Report.WhereChangeHappened = "TimeM";
                        }
                        if (ReportResponsibleGamingOfficerCu.LocationList.ToString() != rdr["LocationList"].ToString())
                        {
                            Report.HasChange = true; flag = 1;
                            Report.WhereChangeHappened = "LocationList";
                        }
                        if (ReportResponsibleGamingOfficerCu.LocationOther.ToString() != rdr["LocationOther"].ToString())
                        {
                            Report.HasChange = true; flag = 1;
                            Report.WhereChangeHappened = "LocationOther";
                        }
                        if (ReportResponsibleGamingOfficerCu.LocationMachine.ToString() != rdr["LocationMachine"].ToString())
                        {
                            Report.HasChange = true; flag = 1;
                            Report.WhereChangeHappened = "LocationMachine";
                        }
                        if (ReportResponsibleGamingOfficerCu.RGONotifiedList.ToString() != rdr["RGONotifiedList"].ToString())
                        {
                            Report.HasChange = true; flag = 1;
                            Report.WhereChangeHappened = "RGONotifiedList";
                        }
                        if (ReportResponsibleGamingOfficerCu.PatronSignsOther.ToString() != rdr["PatronSignsOther"].ToString())
                        {
                            Report.HasChange = true; flag = 1;
                            Report.WhereChangeHappened = "PatronSignsOther";
                        }
                        if (ReportResponsibleGamingOfficerCu.PatronsSignsList.ToString() != rdr["PatronsSignsList"].ToString())
                        {
                            Report.HasChange = true; flag = 1;
                            Report.WhereChangeHappened = "PatronsSignsList";
                        }
                        if (ReportResponsibleGamingOfficerCu.InitialActionList.ToString() != rdr["InitialActionList"].ToString())
                        {
                            Report.HasChange = true; flag = 1;
                            Report.WhereChangeHappened = "InitialActionList";
                        }
                        if (ReportResponsibleGamingOfficerCu.AlertResponseList.ToString() != rdr["AlertResponseList"].ToString())
                        {
                            Report.HasChange = true; flag = 1;
                            Report.WhereChangeHappened = "AlertResponseList";
                        }
                        if (ReportResponsibleGamingOfficerCu.PatronResponseList.ToString() != rdr["PatronResponseList"].ToString())
                        {
                            Report.HasChange = true; flag = 1;
                            Report.WhereChangeHappened = "PatronResponseList";
                        }
                        if (ReportResponsibleGamingOfficerCu.EventOutcomeList.ToString() != rdr["EventOutcomeList"].ToString())
                        {
                            Report.HasChange = true; flag = 1;
                            Report.WhereChangeHappened = "EventOutcomeList";
                        }
                        if (ReportResponsibleGamingOfficerCu.EventOutcomeFurtherComments.ToString() != rdr["EventOutcomeFurtherComments"].ToString())
                        {
                            Report.HasChange = true; flag = 1;
                            Report.WhereChangeHappened = "EventOutcomeFurtherComments";
                        }
                        if (ReportResponsibleGamingOfficerCu.WitnessRecorded.ToString().ToLower() != Convert.ToBoolean(rdr["WitnessRecorded"]).ToString().ToLower())
                        {
                            Report.HasChange = true; flag = 1;
                            Report.WhereChangeHappened = "WitnessRecorded";
                        }
                        if (ReportResponsibleGamingOfficerCu.WitnessDetails.ToString() != rdr["WitnessDetails"].ToString())
                        {
                            Report.HasChange = true; flag = 1;
                            Report.WhereChangeHappened = "WitnessDetails";
                        }
                        if (ReportResponsibleGamingOfficerCu.PoliceNotified.ToString().ToLower() != Convert.ToBoolean(rdr["PoliceNotified"]).ToString().ToLower())
                        {
                            Report.HasChange = true; flag = 1;
                            Report.WhereChangeHappened = "PoliceNotified";
                        }
                        if (ReportResponsibleGamingOfficerCu.PoliceDetails.ToString() != rdr["PoliceDetails"].ToString())
                        {
                            Report.HasChange = true; flag = 1;
                            Report.WhereChangeHappened = "PoliceDetails";
                        }
                        if (ReportResponsibleGamingOfficerCu.IncidentReportCompleted.ToString().ToLower() != Convert.ToBoolean(rdr["IncidentReportCompleted"]).ToString().ToLower())
                        {
                            Report.HasChange = true; flag = 1;
                            Report.WhereChangeHappened = "IncidentReportCompleted";
                        }
                        if (ReportResponsibleGamingOfficerCu.AssistedCompletingIncidentReport.ToString().ToLower() != Convert.ToBoolean(rdr["AssistedCompletingIncidentReport"]).ToString().ToLower())
                        {
                            Report.HasChange = true; flag = 1;
            ...
            else // there's nothing to read, the entered membership number is not found / doesn't exist
            {
                if (method.Equals("SearchMember")) // reset member fields
                {
                    ...
                    ReportResponsibleGamingOfficerCu.MemberPhoto = null; // set global variable to current member photo                       
    ...
    protected void setGlobalVar()
    {
        ...
        ReportResponsibleGamingOfficerCu.EventType = eventType;
        ReportResponsibleGamingOfficerCu.EventTypeOther = txtEventOthers.Text.Replace("'", "^");
        ReportResponsibleGamingOfficerCu.RGONotifiedOther = txtRGONotifiedOther.Text.Replace("'", "^");

        ReportResponsibleGamingOfficerCu.PatronDetailsRecorded = cbPatronDetailsRecorded.Checked.ToString();

        ReportResponsibleGamingOfficerCu.First = txtFirstName.Text.Replace("'", "^");
        ReportResponsibleGamingOfficerCu.Last = txtLastName.Text.Replace("'", "^");
        ReportResponsibleGamingOfficerCu.Alias = txtAlias.Text.Replace("'", "^");
        ReportResponsibleGamingOfficerCu.Contact = txtContact.Text.Replace("'", "^");
        ReportResponsibleGamingOfficerCu.PartyType = ddlPartyType.SelectedItem.Value;
        ReportResponsibleGamingOfficerCu.TxtPartyType = ddlPartyType.SelectedItem.Text;
        if (ddlPartyType.SelectedItem.Value == "1")
        {
            ReportResponsibleGamingOfficerCu.Member = txtMemberNo.Text.Replace("'", "^");
            ReportResponsibleGamingOfficerCu.MDOB = txtDOB.Text;
            ReportResponsibleGamingOfficerCu.MemberSince = txtMemberSince.Text;
            ReportResponsibleGamingOfficerCu.MAddress = txtAddress.Text.Replace("'", "^");
            ReportResponsibleGamingOfficerCu.SignInSlip = "false";

            // clear Visitor selection
            ReportResponsibleGamingOfficerCu.SignInBy = "";
            ReportResponsibleGamingOfficerCu.VDOB = "";
            ReportResponsibleGamingOfficerCu.VAddress = "";
            ReportResponsibleGamingOfficerCu.VProofID = "";
        }
        else if (ddlPartyType.SelectedItem.Value == "2")
        {
            ReportResponsibleGamingOfficerCu.SignInSlip = cbSignInSlip.Checked.ToString();
            ReportResponsibleGamingOfficerCu.SignInBy = txtSignInBy.Text.Replace("'", "^");
            ReportResponsibleGamingOfficerCu.VDOB = txtDOBv.Text;
            ReportResponsibleGamingOfficerCu.VAddress = txtAddressv.Text.Replace("'", "^");
            ReportResponsibleGamingOfficerCu.VProofID = txtIDProof.Text.Replace("'", "^");

            // clear Member selection
            ReportResponsibleGamingOfficerCu.Member = "";
            ReportResponsibleGamingOfficerCu.MDOB = "";
            ReportResponsibleGamingOfficerCu.MAddress = "";
            ReportResponsibleGamingOfficerCu.MemberSince = "";
        }
        else
        {
        ...
        ReportResponsibleGamingOfficerCu.Date = txtDate.Text;
        ReportResponsibleGamingOfficerCu.TxtTimeH = ddlHour.SelectedItem.Text;
        ReportResponsibleGamingOfficerCu.Hour = ddlHour.SelectedItem.Value;
        ReportResponsibleGamingOfficerCu.TxtTimeM = ddlMinutes.SelectedItem.Text;
        ReportResponsibleGamingOfficerCu.Minute = ddlMinutes.SelectedItem.Value;
        ...
        ReportResponsibleGamingOfficerCu.LocationList = location;
        ReportResponsibleGamingOfficerCu.LocationOther = txtLocationOther.Text.Replace("'", "^");
        ReportResponsibleGamingOfficerCu.LocationMachine = txtLocationMachine.Text.Replace("'", "^");
        ...
        ReportResponsibleGamingOfficerCu.RGONotifiedList = rgoNotified;
        ReportResponsibleGamingOfficerCu.RGONotifiedOther = txtRGONotifiedOther.Text.Replace("'", "^");
        ...
        ReportResponsibleGamingOfficerCu.PatronsSignsList = patronSigns;
        ReportResponsibleGamingOfficerCu.PatronSignsOther = txtPatronSignsOther.Text.Replace("'", "^");
        ...
        ReportResponsibleGamingOfficerCu.InitialActionList = initialAction;
        ...
        ReportResponsibleGamingOfficerCu.AlertResponseList = alertResponse;
        ...
        ReportResponsibleGamingOfficerCu.PatronResponseList = patronResponse;
        ...
        ReportResponsibleGamingOfficerCu.EventOutcomeList = eventOutcome;
        ReportResponsibleGamingOfficerCu.EventOutcomeFurtherComments = txtFurtherComments.Text.Replace("\n", "<br />");

        ReportResponsibleGamingOfficerCu.WitnessRecorded = cbWitnessRecorded.Checked.ToString();
        ReportResponsibleGamingOfficerCu.WitnessDetails = txtWitnessDetails.Text.Replace("\n", "<br />");
        ReportResponsibleGamingOfficerCu.PoliceNotified = cbPoliceRecorded.Checked.ToString();
        ReportResponsibleGamingOfficerCu.PoliceDetails = txtPoliceDetails.Text.Replace("\n", "<br />");

        ReportResponsibleGamingOfficerCu.IncidentReportCompleted = cbIncidentReportCompleted.Checked.ToString();
        ReportResponsibleGamingOfficerCu.AssistedCompletingIncidentReport = cbAssistedCompletingIncidentReport.Checked.ToString();
    ...
    protected void ddlPartyType_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        else if (ddlPartyType.SelectedItem.Text == "Visitor")
        {
            ...
            ReportResponsibleGamingOfficerCu.MemberSince = "";
            ReportResponsibleGamingOfficerCu.MAddress = "";
            ReportResponsibleGamingOfficerCu.MemberPhoto = null;
            txtFirstName.Focus();
        }

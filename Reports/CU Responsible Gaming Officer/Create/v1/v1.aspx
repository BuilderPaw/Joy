<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="v1.aspx.cs" Inherits="Reports_CU_Responsible_Gaming_Officer_Create_v1_v1" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" UpdateMode="Conditional" runat="server">
        <ContentTemplate>
            ...
            <div id="body" runat="server" class="body">
                <br />
                <h4 style="margin-left: 8%">CU RGO Event Report</h4>
                ...
                <table class="table-incident">
                    ...
                    <tr id="treventTypeOther1" visible="false" runat="server">
                        <td colspan="4">
                            <asp:TextBox ID="txtEventOthers" class="object-default" runat="server" Height="50px" Style="resize: none;" TextMode="MultiLine"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                ...
                <table id="tblPerson1" class="table-incident" runat="server" visible="false">
                    <tr>
                        ...
                        <td id="member11" runat="server" visible="false" colspan="1">
                            <asp:TextBox onkeypress="return CancelReturnKey(event)" ID="txtMemberNo" OnTextChanged="txtMemberNo_TextChanged" AutoPostBack="true" class="object-default" runat="server" Style="resize: none;"></asp:TextBox>
                    ...
                    <tr>
                        ...
                        <td id="visitor11" runat="server" visible="false" colspan="1">
                            <asp:CheckBox ID="cbSignInSlip" runat="server" />
                        </td>
                        ...
                        <td id="visitor12" runat="server" visible="false" colspan="1">
                            <asp:TextBox onkeypress="return CancelReturnKey(event)" ID="txtSignInBy" class="object-default" runat="server" Style="resize: none;"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td id="member13l" runat="server" visible="false" colspan="2"><b>Date of Birth : </b>
                            <br />
                            <asp:TextBox onkeypress="return CancelReturnKey(event)" ID="txtDOB" Enabled="false" runat="server" class="object-default" autocomplete="off"></asp:TextBox>
                            ...
                            <b>Member Since : </b>
                            <br />
                            <asp:TextBox onkeypress="return CancelReturnKey(event)" ID="txtMemberSince" Enabled="false" runat="server" class="object-default" autocomplete="off"></asp:TextBox>
                            <br />
                            <br />
                            <b>Address : </b>
                            <br />
                            <asp:TextBox onkeypress="return CancelReturnKey(event)" ID="txtAddress" runat="server" Width="100%" Style="resize: none;" class="object-default" autocomplete="off"></asp:TextBox>
                        </td>
                        ...
                        <td id="visitor13" runat="server" visible="false" colspan="1">
                            <asp:TextBox onkeypress="return CancelReturnKey(event)" ID="txtDOBv" runat="server" Placeholder="Select Date" class="object-default" autocomplete="off"></asp:TextBox>
                        ...
                        <td id="visitor14" runat="server" visible="false" colspan="1">
                            <asp:TextBox onkeypress="return CancelReturnKey(event)" ID="txtIDProof" runat="server" class="object-default" autocomplete="off"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td id="visitor15" runat="server" visible="false" colspan="3">
                            <asp:TextBox onkeypress="return CancelReturnKey(event)" ID="txtAddressv" runat="server" Style="resize: none;" class="object-default" autocomplete="off"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2"><b>First Name : </b>
                            <asp:TextBox onkeypress="return CancelReturnKey(event)" ID="txtFirstName" class="object-default" runat="server" Width="100%" Height="35px" Style="resize: none;"></asp:TextBox>
                        </td>
                        <td colspan="2"><b>Last Name : </b>
                            <asp:TextBox onkeypress="return CancelReturnKey(event)" ID="txtLastName" class="object-default" runat="server" Height="35px" Style="resize: none;"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td colspan="4">
                            <asp:TextBox onkeypress="return CancelReturnKey(event)" ID="txtAlias" class="object-default" runat="server" Height="35px" Style="resize: none;"></asp:TextBox></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td colspan="4">
                            <asp:TextBox onkeypress="return CancelReturnKey(event)" ID="txtContact" class="object-default" runat="server" Height="35px" Style="resize: none;"></asp:TextBox></td>
                    </tr>
                </table>
                <table class="table-incident">
                    <tr>
                    ...
                    <tr style="display: inline-block;">
                        <td style="width: 173px">
                            <asp:TextBox onkeypress="return CancelReturnKey(event)" ID="txtDate" runat="server" Width="220px" Placeholder="Select Date" class="object-default" autocomplete="off"></asp:TextBox>
                ...
                <table class="table-incident">
                    ...
                    <tr>
                        <td colspan="4">
                            <asp:TextBox ID="txtLocationOther" Visible="false" onkeyup="setHeight(this);" onkeydown="setHeight(this);" class="object-default" runat="server" Style="resize: none;" Height="40px" TextMode="MultiLine"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td colspan="4">
                            <asp:TextBox ID="txtLocationMachine" class="object-default" runat="server" Style="resize: none;"></asp:TextBox>
                        </td>
                    </tr>
                </table>
                <table class="table-incident">
                    ...
                    <tr>
                        <td colspan="4">
                            <asp:CheckBoxList ID="List_RGONotified" RepeatLayout="table" RepeatColumns="5" Font-Size="8" RepeatDirection="vertical" runat="server" class="object-default">
                            </asp:CheckBoxList>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td colspan="4">
                            <asp:TextBox ID="txtRGONotifiedOther" class="object-default" runat="server" Height="70px" Style="resize: none;" TextMode="MultiLine"></asp:TextBox>
                        </td>
                    </tr>
                </table>
                <table class="table-incident" id="tbllistofsignsofproblemgambling" runat="server">
                    ...
                    <tr>
                        <td colspan="4">
                            <asp:CheckBoxList ID="List_PatronSigns_GeneralWarningSigns_LengthOfPlay" RepeatLayout="table" RepeatColumns="3" Font-Size="8" RepeatDirection="vertical" runat="server" class="object-default">
                            </asp:CheckBoxList>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td colspan="4">
                            <asp:CheckBoxList ID="List_PatronSigns_GeneralWarningSigns_Money" RepeatLayout="table" RepeatColumns="2" Font-Size="8" RepeatDirection="vertical" runat="server" class="object-default">
                            </asp:CheckBoxList>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td colspan="4">
                            <asp:CheckBoxList ID="List_PatronSigns_GeneralWarningSigns_BehaviourDuringPlay" RepeatLayout="table" RepeatColumns="3" Font-Size="8" RepeatDirection="vertical" runat="server" class="object-default">
                            </asp:CheckBoxList>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td colspan="4">
                            <asp:CheckBoxList ID="List_PatronSigns_ProbableWarningSigns_LengthOfPlay" RepeatLayout="table" RepeatColumns="3" Font-Size="8" RepeatDirection="vertical" runat="server" class="object-default">
                            </asp:CheckBoxList>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td colspan="4">
                            <asp:CheckBoxList ID="List_PatronSigns_ProbableWarningSigns_Money" RepeatLayout="table" RepeatColumns="3" Font-Size="8" RepeatDirection="vertical" runat="server" class="object-default">
                            </asp:CheckBoxList>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td colspan="4">
                            <asp:CheckBoxList ID="List_PatronSigns_ProbableWarningSigns_BehaviourDuringPlay" RepeatLayout="table" RepeatColumns="3" Font-Size="8" RepeatDirection="vertical" runat="server" class="object-default">
                            </asp:CheckBoxList>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td colspan="4">
                            <asp:CheckBoxList ID="List_PatronSigns_ProbableWarningSigns_SocialBehaviours" RepeatLayout="table" RepeatColumns="3" Font-Size="8" RepeatDirection="vertical" runat="server" class="object-default">
                            </asp:CheckBoxList>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td colspan="4">
                            <asp:CheckBoxList ID="List_PatronSigns_StrongWarningSigns_LengthOfPlay" RepeatLayout="table" RepeatColumns="2" Font-Size="8" RepeatDirection="vertical" runat="server" class="object-default">
                            </asp:CheckBoxList>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td colspan="4">
                            <asp:CheckBoxList ID="List_PatronSigns_StrongWarningSigns_Money" RepeatLayout="table" RepeatColumns="2" Font-Size="8" RepeatDirection="vertical" runat="server" class="object-default">
                            </asp:CheckBoxList>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td colspan="4">
                            <asp:CheckBoxList ID="List_PatronSigns_StrongWarningSigns_BehaviourDuringPlay" RepeatLayout="table" RepeatColumns="2" Font-Size="8" RepeatDirection="vertical" runat="server" class="object-default">
                            </asp:CheckBoxList>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td colspan="4">
                            <asp:CheckBoxList ID="List_PatronSigns_StrongWarningSigns_SocialBehaviours" RepeatLayout="table" RepeatColumns="2" Font-Size="8" RepeatDirection="vertical" runat="server" class="object-default">
                            </asp:CheckBoxList>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td colspan="4">
                            <asp:TextBox ID="txtPatronSignsOther" class="object-default" runat="server" Height="70px" Style="resize: none;" TextMode="MultiLine"></asp:TextBox>
                        </td>
                    </tr>
                </table>
                <table class="table-incident">
                    ...
                    <tr>
                        <td colspan="4">
                            <asp:CheckBoxList ID="List_InitialAction" RepeatLayout="table" RepeatColumns="4" Font-Size="8" RepeatDirection="vertical" runat="server" class="object-default">
                            </asp:CheckBoxList>
                        </td>
                    </tr>
                </table>
                <table class="table-incident">
                    <tr>
                        <th colspan="4">Which of the clubs gaming break options did you explain?</th>
                    </tr>
                    <tr>
                        <td colspan="4">
                ...
                <table class="table-incident">
                    ...
                    <tr>
                        <td colspan="4">
                            <asp:CheckBoxList ID="List_PatronResponse" RepeatLayout="table" RepeatColumns="4" Font-Size="8" RepeatDirection="vertical" runat="server" class="object-default">
                            </asp:CheckBoxList>
                        </td>
                    </tr>
                </table>
                <table class="table-incident">
                    ...
                    <tr>
                        <td colspan="4">
                            <asp:CheckBoxList ID="List_EventOutcome" RepeatLayout="table" RepeatColumns="4" Font-Size="8" RepeatDirection="vertical" runat="server" class="object-default">
                            </asp:CheckBoxList>
                        </td>
                    </tr>
                    <tr>

<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="v2.aspx.cs" Inherits="Reports_MR_Reception_Supervisor_Create_v2_v2" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="body">
        <br />
        <h4 style="margin-left: 8%;">MR Reception Supervisor Report</h4>
        <table class="table-create-report">
            ...
            <tr>
                <td colspan="4">
                    <asp:TextBox ID="txtSpecialComments" class="object-default" runat="server" Height="130px" Style="resize: none;" TextMode="MultiLine"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td colspan="2">&nbsp;</td>

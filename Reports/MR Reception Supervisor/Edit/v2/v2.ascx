<%@ Control Language="C#" AutoEventWireup="true" CodeFile="v2.ascx.cs" Inherits="Reports_MR_Reception_Supervisor_Edit_v2_v2" %>
...
<div class="body3">
    ...
    <table class="table-incident">
        ...
        <tr>
            <td colspan="4">
                <asp:TextBox ID="txtSpecialComments" class="object-default" OnTextChanged="TextChanged_TextChanged" TextMode="MultiLine" runat="server" Height="130px" Text="" Style="resize: none;"></asp:TextBox>
            </td>
        </tr>
    </table>
</div>
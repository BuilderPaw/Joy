<%@ Control Language="C#" AutoEventWireup="true" CodeFile="v1.ascx.cs" Inherits="Reports_MR_Reception_Supervisor_Print_v1_Active_v1" %>
<div style="font-family: Arial">
    ...
    <h4 style="margin-left: 48.5%; font-family: Arial"><%# Eval("ReportName") %> ID No. <span style="color: red;"><b><%# Eval("ReportId") %></b></span></h4>

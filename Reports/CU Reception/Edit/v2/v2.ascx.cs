...
public partial class Reports_CU_Reception_Edit_v2_v2 : System.Web.UI.UserControl
{
            ...
            if (rdr.HasRows)
            {
                while (rdr.Read())
                {
                    ...
                    if (method.Equals("checkChanges"))
                    {
                        ...
                        if (ReportReceptionCu.SpecialComments != rdr["SpecialComments"].ToString())
                        {
                            Report.HasChange = true; flag = 1;
    ...
    protected void SetStaticVariable()
    {
        ...
        ReportReceptionCu.SpecialComments = txtSpecialComments.Text.Replace("\n", "<br />");
    }
}
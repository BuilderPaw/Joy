...
public partial class Reports_CU_Incident_Report_View_v1_Link_v1 : System.Web.UI.UserControl
{
            ...
            if (rdr.HasRows)
            {
                while (rdr.Read())
                {
                    if (method.Equals("getFields"))
                    {
                        ...
                        {
                            ReportIncidentCu.ViewPlayerId1 = rdr["PlayerId1"].ToString();
                        }
                        if (!String.IsNullOrEmpty(rdr["PlayerId2"].ToString()))
                        {
                            ReportIncidentCu.ViewPlayerId2 = rdr["PlayerId2"].ToString();
                        }
                        if (!String.IsNullOrEmpty(rdr["PlayerId3"].ToString()))
                        {
                            ReportIncidentCu.ViewPlayerId3 = rdr["PlayerId3"].ToString();
                        }
                        if (!String.IsNullOrEmpty(rdr["PlayerId4"].ToString()))
                        {
                            ReportIncidentCu.ViewPlayerId4 = rdr["PlayerId4"].ToString();
                        }
                        if (!String.IsNullOrEmpty(rdr["PlayerId5"].ToString()))
                        {
                            ReportIncidentCu.ViewPlayerId5 = rdr["PlayerId5"].ToString();
                        }

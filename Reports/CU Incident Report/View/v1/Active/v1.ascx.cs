...
public partial class Reports_CU_Incident_Report_View_v1_v1 : System.Web.UI.UserControl
{
    ...
    {
        if (Report.SelectedStaffId == UserCredentials.StaffId || UserCredentials.GroupsQuery.Contains("Duty Manager") || UserCredentials.GroupsQuery.Contains("Senior Manager")) // if it is a member of Duty or Senior Manager display the Incident Report
        {

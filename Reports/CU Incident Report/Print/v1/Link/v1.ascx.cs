...
public partial class Reports_CU_Incident_Report_Print_v1_Link_v1 : System.Web.UI.UserControl
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            if (UserCredentials.GroupsQuery.Contains("Duty Manager") && Report.LinkedTable.Contains("Incident") || UserCredentials.GroupsQuery.Contains("Override")) // if it is a member of Duty Manager display the Incident Report
            {

<%@ Control Language="C#" AutoEventWireup="true" CodeFile="v2.ascx.cs" Inherits="Reports_MR_Supervisors_Edit_v2_v2" %>
...
<div class="body3">
    ...
    <table class="table-incident">
        ...
        <tr>
            <td colspan="4">
                <asp:TextBox ID="txtSpecialComments" class="object-default" runat="server" OnTextChanged="TextChanged_TextChanged" Height="70px" Style="resize: none;" TextMode="MultiLine"></asp:TextBox>
            </td>
        </tr>
    </table>
</div>
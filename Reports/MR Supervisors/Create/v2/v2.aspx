<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="v2.aspx.cs" Inherits="Reports_MR_Supervisors_Create_v2_v2" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="body">
        ...
        <table class="table-create-report">
            ...
            <tr>
                <td colspan="4">
                    <asp:TextBox ID="txtSpecialComments" class="object-default" runat="server" Height="70px" Style="resize: none;" TextMode="MultiLine"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td colspan="2">&nbsp;</td>
